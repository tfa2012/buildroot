...
define LINUX_KCONFIG_FIXUP_CMDS
    ...
    $(if $(BR2_PACKAGE_DVB_WINTV_TUNER),
        $(call KCONFIG_ENABLE_OPT,CONFIG_I2C,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_I2C_BOARDINFO,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_I2C_MUX,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_I2C_HELPER_AUTO,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_BCM_VC_CMA,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DRM,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_ANALOG_TV_SUPPORT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_DIGITAL_TV_SUPPORT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_RADIO_SUPPORT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_SDR_SUPPORT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_DEV,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_V4L2,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_TUNER,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEOBUF2_CORE,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEOBUF2_MEMOPS,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEOBUF2_VMALLOC,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DVB_CORE,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DVB_NET,$(@D)/.config)
        $(call KCONFIG_SET_OPT,CONFIG_DVB_MAX_ADAPTERS,8,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DVB_AU8522,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DVB_AU8522_DTV,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_DVB_AU8522_V4L,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,ONFIG_I2C_ALGOBIT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_USB_SUPPORT,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_AU0828,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_AU0828_V4L2,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_AU0828_RC,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_VIDEO_TVEEPROM,$(@D)/.config)
        $(call KCONFIG_ENABLE_OPT,CONFIG_MEDIA_TUNER_MXL5007T,$(@D)/.config))
endef
