...
ifeq ($(BR2_PACKAGE_BCM_WESTON),y)
    ...
    WPEBACKEND_RDK_DEPENDENCIES += wpeframework wpeframework-plugins libxkbcommon bcm-refsw
    WPEBACKEND_RDK_FLAGS +=-DUSE_BACKEND_WPEFRAMEWORK=ON -DUSE_KEY_INPUT_HANDLING_LINUX_INPUT=OFF -DUSE_HOLE_PUNCH_GSTREAMER=OFF -DUSE_INPUT_LIBINPUT=OFF -DUSE_VIRTUAL_KEYBOARD=OFF -DUSE_INPUT_LIBINPUT=OFF
else
