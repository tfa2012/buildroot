...
WPEFRAMEWORK_COMMON_SITE = git@github.com:WebPlatformForEmbedded/WPEFrameworkPlugins-legacy.git
WPEFRAMEWORK_COMMON_INSTALL_STAGING = YES
WPEFRAMEWORK_COMMON_DEPENDENCIES = wpeframework libpng

WPEFRAMEWORK_COMMON_CONF_OPTS += -DBUILD_REFERENCE=${WPEFRAMEWORK_COMMON_VERSION} -DWPEFRAMEWORK_WEB_UI=ON -DWPEFRAMEWORK_PLUGIN_REMOTECONTROL_IRNEXUS=ON
