...
WPEFRAMEWORK_PLUGINS_VERSION = 28ef4f4bd735f3a44983b80f9c6553de938af6bc
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_COMPOSITOR_BOXMODE="$(call qstrip,$(BR2_PACKAGE_BCM_REFSW_BOXMODE))"
endif
ifneq ($(BR2_PACKAGE_BCM_REFSW_GRAPHICS_HEAP_SIZE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_COMPOSITOR_GRAPHICS_HEAP_SIZE="$(call qstrip,$(BR2_PACKAGE_BCM_REFSW_GRAPHICS_HEAP_SIZE))"
endif
else
